...
<body>
    ...
    <section class="h-100 gradient-form" style="background-color: rgb(223, 219, 219);">
                ...
                <div class="row g-0">
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                      <h4 class="mb-4">Centro Ecoturístico</h4>
                      <p class="small mb-0">Impulsando el turismo, la consientización del medio ambiente tanto de la flora y la fauna.
                        Ademas del maximo reconocimiento como mejor empresa. </p>
                    </div>
                  </div>
                </div>
              </div>
